...
AL2O3_FORCE_INLINE MeshMod_Vertex##postfix * MeshMod_MeshMod_Vertex##postfix##TagHandleToPtr(MeshMod_MeshHandle meshHandle, MeshMod_VertexHandle vertexHandle) { \
	return  (MeshMod_Vertex##postfix *) MeshMod_MeshVertexTagHandleToPtr(meshHandle, MeshMod_Vertex##postfix##Tag, vertexHandle); \
}
