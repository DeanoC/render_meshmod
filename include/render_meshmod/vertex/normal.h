...
AL2O3_FORCE_INLINE MeshMod_VertexNormal * MeshMod_MeshMod_VertexNormalTagHandleToPtr(MeshMod_MeshHandle meshHandle, MeshMod_VertexHandle vertexHandle, uint8_t userTag) {
