...
AL2O3_FORCE_INLINE type * MeshMod_Edge##postfix##TagHandleToPtr(MeshMod_MeshHandle meshHandle, MeshMod_EdgeHandle edgeHandle, uint8_t userTag) { \
	return (type *) MeshMod_MeshEdgeTagHandleToPtr(meshHandle, MeshMod_AddUserDataToEdgeTag(MeshMod_Edge##postfix##Tag, userTag), edgeHandle); \
}

#define MESHMOD_ET_VECTOR_TYPE(postfix) typedef Math_##postfix MeshMod_Edge##postfix; \
AL2O3_FORCE_INLINE Math_##postfix * MeshMod_Edge##postfix##TagHandleToPtr(MeshMod_MeshHandle meshHandle, MeshMod_EdgeHandle edgeHandle, uint8_t userTag) { \
	return (Math_##postfix *) MeshMod_MeshEdgeTagHandleToPtr(meshHandle, MeshMod_AddUserDataToEdgeTag(MeshMod_Edge##postfix##Tag, userTag), edgeHandle); \
}
